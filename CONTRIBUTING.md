...
- [Contributor License Agreement](https://git.k8s.io/community/CLA.md) Kubernetes
  projects require that you sign a Contributor License Agreement (CLA) before we
  can accept your pull requests
- [Kubernetes Contributor Guide](https://git.k8s.io/community/contributors/guide)
  - Main contributor documentation, or you can just jump directly to the
    [contributing section](https://git.k8s.io/community/contributors/guide#contributing)
...
This repository has a dual-layer layout: hand-maintained code under `tools/`
and a generated assembly area produced by `tools/scripts/sync.sh`. Before
contributing, read [CODE_LAYOUT.md](CODE_LAYOUT.md) to understand which files
are the source of truth (edit under `tools/`) and which are generated (do not
edit by hand).
