...
import (
	...
	"github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pkg/controller"
	...
	"github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pkg/modifycontroller"
...
func resizer_main(ctx context.Context) {
