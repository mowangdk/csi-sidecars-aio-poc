...
- Add support for cross-namespace data sources alpha feature ([#805](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/805), [@ttakahashi21]
- Register metrics exposed by sig-storage-lib ([#792](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/792), [@RaunakShah](https://github.com/RaunakShah))
- Update the annotation that needs to be applies to VolumeSnapshotContents from snapshot.storage.kubernetes.io/allowVolumeModeChange to snapshot.storage.kubernetes.io/allow-volume-mode-change ([#791](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/791), [@RaunakShah](https://github.com/RaunakShah))

### Bug or Regression

- Fix string pointer comparison for source volume mode conversion ([#793](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/793), [@RaunakShah](https://github.com/RaunakShah))
- Fix nil pointer crash for PV without ClaimRef ([#796](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/796), [@zezaeoh](https://github.com/zezaeoh))

### Uncategorized

- Update go to 1.19 and dependencies for k8s v1.26.0 ([#834](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/834), [@sunnylovestiramisu](https://github.com/sunnylovestiramisu))
