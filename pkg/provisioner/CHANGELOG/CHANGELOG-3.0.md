...
- Update external-snapshotter dependency to v4, enabling use of the volume snapshot v1 client, which requires minimum Kubernetes version 1.20 ([#650](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/650), [@xinyanw409](https://github.com/xinyanw409))

## Changes by Kind

### Feature

- Add command line arguments to configure leader election options ([#643](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/643), [@RaunakShah](https://github.com/RaunakShah))
- Adds mappings for PV access modes to new CSI access modes: `SINGLE_NODE_SINGLE_WRITER` and `SINGLE_NODE_MULTI_WRITER`. ([#630](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/630), [@chrishenzie](https://github.com/chrishenzie))
- The provisioner sidecar now has an argument called `controller-publish-readonly` which sets the value of CSI PV spec `readonly` field value based on the PVC access mode. If this flag is set to `true` and the PVC access mode only contains the `ROX` access mode, the controller automatically sets `PersistentVolume.spec.CSIPersistentVolumeSource.readOnly` field to `true`. ([#469](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/469), [@humblec](https://github.com/humblec))
- Updates Kubernetes dependencies to v1.22.0 ([#660](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/660), [@chrishenzie](https://github.com/chrishenzie)) [SIG Storage]
- Updates container-storage-interface dependency to v1.5.0 ([#644](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/644), [@chrishenzie](https://github.com/chrishenzie))

### Bug or Regression

- Fix a bug that not being able to use block device mode when enable a storage capacity tracking mode. ([#635](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/635), [@bells17](https://github.com/bells17))
- Fix a data race in cloning protection controller ([#651](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/651), [@tksm](https://github.com/tksm))
- Fix capacity information updates when topology changes. Only affected central deployment and network attached storage, not deployment on each node. This broke in v2.2.0 as part of a bug fix for capacity informer handling. ([#617](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/617), [@bai3shuo4](https://github.com/bai3shuo4))
- Fix env name from POD_NAMESPACE to NAMESPACE for capacity-ownerref-level option. ([#636](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/636), [@bells17](https://github.com/bells17))
- Fixed reporting of metrics when a migratable CSI driver is used. ([#620](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/620), [@jsafrane](https://github.com/jsafrane))
- Newly provisioned CSI Migration enabled PV will have "provisioned-by" annotation set to in-tree provisioner name instead of the CSI provisioner ([#646](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/646), [@wongma7](https://github.com/wongma7))
...
- github.com/go-openapi/spec: [v0.19.5 → v0.19.3](https://github.com/go-openapi/spec/compare/v0.19.5...v0.19.3)
...
- github.com/mattn/go-runewidth: [v0.0.7 → v0.0.2](https://github.com/mattn/go-runewidth/compare/v0.0.7...v0.0.2)
...
- github.com/cilium/ebpf: [v0.2.0](https://github.com/cilium/ebpf/tree/v0.2.0)
...
- github.com/containerd/console: [v1.0.1](https://github.com/containerd/console/tree/v1.0.1)
- github.com/containerd/containerd: [v1.4.4](https://github.com/containerd/containerd/tree/v1.4.4)
...
- github.com/coredns/corefile-migration: [v1.0.11](https://github.com/coredns/corefile-migration/tree/v1.0.11)
...
- github.com/docker/docker: [v20.10.2+incompatible](https://github.com/docker/docker/tree/v20.10.2)
...
- github.com/google/cadvisor: [v0.39.0](https://github.com/google/cadvisor/tree/v0.39.0)
...
- github.com/heketi/heketi: [v10.2.0+incompatible](https://github.com/heketi/heketi/tree/v10.2.0)
...
- github.com/moby/sys/mountinfo: [v0.4.0](https://github.com/moby/sys/mountinfo/tree/v0.4.0)
...
- github.com/opencontainers/runc: [v1.0.0-rc93](https://github.com/opencontainers/runc/tree/v1.0.0-rc93)
- github.com/opencontainers/runtime-spec: [e6143ca](https://github.com/opencontainers/runtime-spec/tree/e6143ca)
- github.com/opencontainers/selinux: [v1.8.0](https://github.com/opencontainers/selinux/tree/v1.8.0)
...
- k8s.io/kube-controller-manager: v0.21.0
...
- k8s.io/sample-apiserver: v0.21.0
