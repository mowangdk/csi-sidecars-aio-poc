...
- Add support for -logging-format=json
  Remove klog specific flags according to KEP-2845 ([#1318](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/1318), [@huww98](https://github.com/huww98))

### Other (Cleanup or Flake)

- Updated CSI spec to 1.10.0 ([#1262](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/1262), [@jsafrane](https://github.com/jsafrane))

### Uncategorized

- Fix CVE-2024-45337 ([#1314](https://github.com/kubernetes-csi/csi-sidecars/pkg/provisioner/pull/1314), [@shannon](https://github.com/shannon))
