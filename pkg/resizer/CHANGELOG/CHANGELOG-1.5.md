...
- Kube client dependencies are updated to v1.24.0 ([#204](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/204), [@humblec](https://github.com/humblec))
