...
- Annotate PVCs that don't require node expansion, so as kubelet can skip them ([#496](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/496), [@gnufied](https://github.com/gnufied))
- Promote VolumeAttributesClass to GA ([#515](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/515), [@carlory](https://github.com/carlory))
- Support rolling back when modify failed ([#513](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/513), [@huww98](https://github.com/huww98))
- VolumeAttributesClass feature gate defaults to false if VAC API v1 is not available ([#532](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/532), [@huww98](https://github.com/huww98))
- Rbac change for VolumeAttributesClass ([#537](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/537), [@sunnylovestiramisu](https://github.com/sunnylovestiramisu))

### Bug or Regression

- BugFix: rare flake when resizing close to creation time (no requeue over "PV bound to PVC not found") ([#521](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/521), [@akalenyu](https://github.com/akalenyu))

### Other (Cleanup or Flake)

- Removed the slowset utility and moved it to the shared csi-lib-utils. ([#494](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/494), [@mdzraf](https://github.com/mdzraf))
- Update kubernetes dependencies to v1.34.0 ([#525](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/525), [@dfajmon](https://github.com/dfajmon))
- Update CSI spec to v1.12.0 which moves volume modification feature to stable ([#534](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/534), [@gnufied](https://github.com/gnufied))
