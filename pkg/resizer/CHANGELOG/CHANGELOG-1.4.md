...
- Fix unnecessary warning when PV bound to PVC is not created yet. ([#172](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/172), [@takuhiro](https://github.com/takuhiro))

### Feature
- Add support to allow users to recover from expansion failures ([#187](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/187), [@gnufied](https://github.com/gnufied))


### Other (Cleanup or Flake)

- Kubernetes client-go dependencies are updated to v1.23.1 ([#186](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/186), [@humblec](https://github.com/humblec))
- Updates Kubernetes dependencies to v1.23.0 ([#184](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/184), [@humblec](https://github.com/humblec))
