...
- Kube client dependencies are updated to v1.25.0 ([#220](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/220), [@humblec](https://github.com/humblec))
