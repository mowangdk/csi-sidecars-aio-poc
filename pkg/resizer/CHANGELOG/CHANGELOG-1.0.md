...
- Adding configurable QPS and Burst to k8s client and use a separate client for leader election. ([#91](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/91), [@RaunakShah](https://github.com/RaunakShah))

### Bug or Regression

- Ensure that we do not resize recently resized volumes ([#96](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/96), [@gnufied](https://github.com/gnufied))

### Uncategorized

- Build with Go 1.15 ([#98](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/98), [@pohly](https://github.com/pohly))
- Publishing of images on k8s.gcr.io ([#84](https://github.com/kubernetes-csi/csi-sidecars/pkg/resizer/pull/84), [@pohly](https://github.com/pohly))
