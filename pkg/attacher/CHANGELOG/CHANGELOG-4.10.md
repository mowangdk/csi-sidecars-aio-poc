...
- Populate VolumeError.ErrorCode field in VolumeAttachment object. ([#662](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/662), [@torredil](https://github.com/torredil))

### Other (Cleanup or Flake)

- Update kubernetes dependencies to v1.34.0 ([#678](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/678), [@dobsonj](https://github.com/dobsonj))
