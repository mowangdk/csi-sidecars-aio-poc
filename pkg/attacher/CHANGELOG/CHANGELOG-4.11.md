...
- Fixed log spam "VolumeAttachment attached status and actual state do not match. Adding back to VolumeAttachment queue for forced reprocessing" for VolumeAttachments of unrelated CSI drivers. ([#682](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/682), [@jsafrane](https://github.com/jsafrane))
- Fixed the module path to include `/v4`. ([#696](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/696), [@jsafrane](https://github.com/jsafrane))
- Updated go version to fix CVE-2025-68121. ([#701](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/701), [@jsafrane](https://github.com/jsafrane))

### Other (Cleanup or Flake)

- Bump k8s dependencies to v1.35.0 ([#693](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/693), [@dfajmon](https://github.com/dfajmon))
