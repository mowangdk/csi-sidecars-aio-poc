...
- Changing distroless image back to multiarch ([#267](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/267), [@namrata-ibm](https://github.com/namrata-ibm))

### Other (Cleanup or Flake)

- Update Kubernetes dependencies to 1.32.0 ([#613](https://github.com/kubernetes-csi/csi-sidecars/pkg/attacher/pull/613), [@dfajmon](https://github.com/dfajmon))
