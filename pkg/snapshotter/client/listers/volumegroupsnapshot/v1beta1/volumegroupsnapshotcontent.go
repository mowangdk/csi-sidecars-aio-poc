...
type VolumeGroupSnapshotContentLister interface {
	...
	List(selector labels.Selector) (ret []*volumegroupsnapshotv1beta1.VolumeGroupSnapshotContent, err error)
	// Get retrieves the VolumeGroupSnapshotContent from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*volumegroupsnapshotv1beta1.VolumeGroupSnapshotContent, error)
...
type volumeGroupSnapshotContentLister struct {
	listers.ResourceIndexer[*volumegroupsnapshotv1beta1.VolumeGroupSnapshotContent]
}
...
func NewVolumeGroupSnapshotContentLister(indexer cache.Indexer) VolumeGroupSnapshotContentLister {
	return &volumeGroupSnapshotContentLister{listers.New[*volumegroupsnapshotv1beta1.VolumeGroupSnapshotContent](indexer, volumegroupsnapshotv1beta1.Resource("volumegroupsnapshotcontent"))}
}
