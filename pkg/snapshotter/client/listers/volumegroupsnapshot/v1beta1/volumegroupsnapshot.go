...
type VolumeGroupSnapshotLister interface {
	...
	List(selector labels.Selector) (ret []*volumegroupsnapshotv1beta1.VolumeGroupSnapshot, err error)
...
type volumeGroupSnapshotLister struct {
	listers.ResourceIndexer[*volumegroupsnapshotv1beta1.VolumeGroupSnapshot]
}
...
func NewVolumeGroupSnapshotLister(indexer cache.Indexer) VolumeGroupSnapshotLister {
	return &volumeGroupSnapshotLister{listers.New[*volumegroupsnapshotv1beta1.VolumeGroupSnapshot](indexer, volumegroupsnapshotv1beta1.Resource("volumegroupsnapshot"))}
}

// VolumeGroupSnapshots returns an object that can list and get VolumeGroupSnapshots.
func (s *volumeGroupSnapshotLister) VolumeGroupSnapshots(namespace string) VolumeGroupSnapshotNamespaceLister {
	return volumeGroupSnapshotNamespaceLister{listers.NewNamespaced[*volumegroupsnapshotv1beta1.VolumeGroupSnapshot](s.ResourceIndexer, namespace)}
}
...
type VolumeGroupSnapshotNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*volumegroupsnapshotv1beta1.VolumeGroupSnapshot, error)
