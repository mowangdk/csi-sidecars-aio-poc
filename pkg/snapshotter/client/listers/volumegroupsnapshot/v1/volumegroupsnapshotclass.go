...
type VolumeGroupSnapshotClassLister interface {
	...
	List(selector labels.Selector) (ret []*volumegroupsnapshotv1.VolumeGroupSnapshotClass, err error)
	// Get retrieves the VolumeGroupSnapshotClass from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*volumegroupsnapshotv1.VolumeGroupSnapshotClass, error)
...
type volumeGroupSnapshotClassLister struct {
	listers.ResourceIndexer[*volumegroupsnapshotv1.VolumeGroupSnapshotClass]
}
...
func NewVolumeGroupSnapshotClassLister(indexer cache.Indexer) VolumeGroupSnapshotClassLister {
	return &volumeGroupSnapshotClassLister{listers.New[*volumegroupsnapshotv1.VolumeGroupSnapshotClass](indexer, volumegroupsnapshotv1.Resource("volumegroupsnapshotclass"))}
}
