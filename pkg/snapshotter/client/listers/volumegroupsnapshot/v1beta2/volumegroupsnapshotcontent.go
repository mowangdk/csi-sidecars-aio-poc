...
import (
	volumegroupsnapshotv1beta2 "github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/client/apis/volumegroupsnapshot/v1beta2"
...
type VolumeGroupSnapshotContentLister interface {
	...
	List(selector labels.Selector) (ret []*volumegroupsnapshotv1beta2.VolumeGroupSnapshotContent, err error)
	// Get retrieves the VolumeGroupSnapshotContent from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*volumegroupsnapshotv1beta2.VolumeGroupSnapshotContent, error)
...
type volumeGroupSnapshotContentLister struct {
	listers.ResourceIndexer[*volumegroupsnapshotv1beta2.VolumeGroupSnapshotContent]
}
...
func NewVolumeGroupSnapshotContentLister(indexer cache.Indexer) VolumeGroupSnapshotContentLister {
	return &volumeGroupSnapshotContentLister{listers.New[*volumegroupsnapshotv1beta2.VolumeGroupSnapshotContent](indexer, volumegroupsnapshotv1beta2.Resource("volumegroupsnapshotcontent"))}
}
