...
import (
	...
	apisvolumegroupsnapshotv1 "github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/client/apis/volumegroupsnapshot/v1"
	...
	volumegroupsnapshotv1 "github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/client/listers/volumegroupsnapshot/v1"
...
type VolumeGroupSnapshotContentInformer interface {
	...
	Lister() volumegroupsnapshotv1.VolumeGroupSnapshotContentLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupsnapshotV1().VolumeGroupSnapshotContents().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotContents().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotContents().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotContents().Watch(ctx, options)
			},
		}, client),
		&apisvolumegroupsnapshotv1.VolumeGroupSnapshotContent{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeGroupSnapshotContentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisvolumegroupsnapshotv1.VolumeGroupSnapshotContent{}, f.defaultInformer)
}

func (f *volumeGroupSnapshotContentInformer) Lister() volumegroupsnapshotv1.VolumeGroupSnapshotContentLister {
	return volumegroupsnapshotv1.NewVolumeGroupSnapshotContentLister(f.Informer().GetIndexer())
}
