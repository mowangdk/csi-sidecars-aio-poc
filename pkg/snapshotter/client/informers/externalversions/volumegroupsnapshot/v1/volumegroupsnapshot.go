...
type VolumeGroupSnapshotInformer interface {
	...
	Lister() volumegroupsnapshotv1.VolumeGroupSnapshotLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupsnapshotV1().VolumeGroupSnapshots(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshots(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshots(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshots(namespace).Watch(ctx, options)
			},
		}, client),
		&apisvolumegroupsnapshotv1.VolumeGroupSnapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeGroupSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisvolumegroupsnapshotv1.VolumeGroupSnapshot{}, f.defaultInformer)
}

func (f *volumeGroupSnapshotInformer) Lister() volumegroupsnapshotv1.VolumeGroupSnapshotLister {
	return volumegroupsnapshotv1.NewVolumeGroupSnapshotLister(f.Informer().GetIndexer())
}
