...
type VolumeGroupSnapshotClassInformer interface {
	...
	Lister() volumegroupsnapshotv1.VolumeGroupSnapshotClassLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupsnapshotV1().VolumeGroupSnapshotClasses().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotClasses().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotClasses().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupsnapshotV1().VolumeGroupSnapshotClasses().Watch(ctx, options)
			},
		}, client),
		&apisvolumegroupsnapshotv1.VolumeGroupSnapshotClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeGroupSnapshotClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisvolumegroupsnapshotv1.VolumeGroupSnapshotClass{}, f.defaultInformer)
}

func (f *volumeGroupSnapshotClassInformer) Lister() volumegroupsnapshotv1.VolumeGroupSnapshotClassLister {
	return volumegroupsnapshotv1.NewVolumeGroupSnapshotClassLister(f.Informer().GetIndexer())
}
