...
func NeedToAddGroupSnapshotContentFinalizer(groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) bool {
...
func IsGroupSnapshotDeletionCandidate(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) bool {
...
func NeedToAddGroupSnapshotBoundFinalizer(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) bool {
...
func GetGroupSnapshotStatusForLogging(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) string {
...
func GroupSnapshotKey(vgs *groupsnapshotv1.VolumeGroupSnapshot) string {
...
func IsGroupSnapshotReady(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) bool {
...
func IsBoundVolumeGroupSnapshotContentNameSet(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) bool {
...
func IsVolumeGroupSnapshotRefSet(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, content *groupsnapshotv1.VolumeGroupSnapshotContent) bool {
...
func IsGroupSnapshotCreated(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) bool {
...
func GetDynamicSnapshotContentNameForGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) string {
