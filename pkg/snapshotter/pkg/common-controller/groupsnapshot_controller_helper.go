...
import (
	...
	groupsnapshotv1 "github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/client/apis/volumegroupsnapshot/v1"
	crdv1 "github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/client/apis/volumesnapshot/v1"
	"github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/pkg/metrics"
	"github.com/kubernetes-csi/csi-sidecars/pkg/snapshotter/pkg/utils"
)
...
func (ctrl *csiSnapshotCommonController) getGroupSnapshotClass(className string) (*groupsnapshotv1.VolumeGroupSnapshotClass, error) {
...
func (ctrl *csiSnapshotCommonController) updateGroupSnapshotErrorStatusWithEvent(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, setReadyToFalse bool, eventtype, reason, message string) error {
	...
	if groupSnapshotClone.Status == nil {
		groupSnapshotClone.Status = &groupsnapshotv1.VolumeGroupSnapshotStatus{}
	}
...
func (ctrl *csiSnapshotCommonController) SetDefaultGroupSnapshotClass(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshotClass, *groupsnapshotv1.VolumeGroupSnapshot, error) {
	...
	defaultClasses := []*groupsnapshotv1.VolumeGroupSnapshotClass{}
...
func (ctrl *csiSnapshotCommonController) pvDriverFromGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (string, error) {
...
func (ctrl *csiSnapshotCommonController) getVolumesFromVolumeGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) ([]*v1.PersistentVolume, error) {
...
func (ctrl *csiSnapshotCommonController) getClaimsFromVolumeGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) ([]v1.PersistentVolumeClaim, error) {
...
func (ctrl *csiSnapshotCommonController) updateGroupSnapshot(ctx context.Context, groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) deleteGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) {
...
func (ctrl *csiSnapshotCommonController) syncGroupSnapshot(ctx context.Context, groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) syncReadyGroupSnapshot(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) getGroupSnapshotContentFromStore(contentName string) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
	...
	groupSnapshotContent, ok := obj.(*groupsnapshotv1.VolumeGroupSnapshotContent)
	if !ok {
...
func (ctrl *csiSnapshotCommonController) syncUnreadyGroupSnapshot(ctx context.Context, groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
	...
	var groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent
...
func (ctrl *csiSnapshotCommonController) createSnapshotsForGroupSnapshotContent(
	ctx context.Context,
	groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent,
	groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot,
) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
...
func (ctrl *csiSnapshotCommonController) getPreprovisionedGroupSnapshotContentFromStore(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
...
func (ctrl *csiSnapshotCommonController) checkAndBindGroupSnapshotContent(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
...
func (ctrl *csiSnapshotCommonController) updateGroupSnapshotStatus(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) (*groupsnapshotv1.VolumeGroupSnapshot, error) {
	...
	groupSnapshotObj, err := ctrl.clientset.GroupsnapshotV1().VolumeGroupSnapshots(groupSnapshot.Namespace).Get(context.TODO(), groupSnapshot.Name, metav1.GetOptions{})
	if err != nil {
		return nil, fmt.Errorf("error get group snapshot %s from api server: %v", utils.GroupSnapshotKey(groupSnapshot), err)
	}

	var newStatus *groupsnapshotv1.VolumeGroupSnapshotStatus
	updated := false
	if groupSnapshotObj.Status == nil {
		newStatus = &groupsnapshotv1.VolumeGroupSnapshotStatus{
...
func (ctrl *csiSnapshotCommonController) getDynamicallyProvisionedGroupContentFromStore(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
...
func (ctrl *csiSnapshotCommonController) bindandUpdateVolumeGroupSnapshot(groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent, groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshot, error) {
	...
	// update group snapshot status
	var updateGroupSnapshot *groupsnapshotv1.VolumeGroupSnapshot
...
func (ctrl *csiSnapshotCommonController) createGroupSnapshotContent(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
	...
	*/
	...
	var updateGroupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent
	...
	if updateGroupSnapshotContent, err = ctrl.clientset.GroupsnapshotV1().VolumeGroupSnapshotContents().Create(context.TODO(), groupSnapshotContent, metav1.CreateOptions{}); err == nil || apierrs.IsAlreadyExists(err) {
		// Save succeeded.
		if err != nil {
...
func (ctrl *csiSnapshotCommonController) getCreateGroupSnapshotInput(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) (*groupsnapshotv1.VolumeGroupSnapshotClass, []*v1.PersistentVolume, string, *v1.SecretReference, error) {
	className := groupSnapshot.Spec.VolumeGroupSnapshotClassName
	klog.V(5).Infof("getCreateGroupSnapshotInput [%s]", groupSnapshot.Name)
	var groupSnapshotClass *groupsnapshotv1.VolumeGroupSnapshotClass
	var err error
	if className != nil {
...
func (ctrl *csiSnapshotCommonController) syncGroupSnapshotContent(groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) error {
	...
	var groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot
...
func (ctrl *csiSnapshotCommonController) getGroupSnapshotFromStore(groupSnapshotName string) (*groupsnapshotv1.VolumeGroupSnapshot, error) {
	...
	var ok bool
	groupSnapshot, ok = obj.(*groupsnapshotv1.VolumeGroupSnapshot)
	if !ok {
...
// status
func (ctrl *csiSnapshotCommonController) needsUpdateGroupSnapshotStatus(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) bool {
...
func (ctrl *csiSnapshotCommonController) addGroupSnapshotContentFinalizer(groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) error {
...
func (ctrl *csiSnapshotCommonController) checkandAddGroupSnapshotFinalizers(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) addGroupSnapshotFinalizer(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, addBoundFinalizer bool) error {
	var updatedGroupSnapshot *groupsnapshotv1.VolumeGroupSnapshot
	var err error
...
func (ctrl *csiSnapshotCommonController) processGroupSnapshotWithDeletionTimestamp(ctx context.Context, groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot) error {
	...
	if groupSnapshotContent != nil && deleteGroupSnapshotContent {
		...
		err := ctrl.clientset.GroupsnapshotV1().VolumeGroupSnapshotContents().Delete(ctx, groupSnapshotContent.Name, metav1.DeleteOptions{})
		if err != nil {
...
func (ctrl *csiSnapshotCommonController) setAnnVolumeGroupSnapshotBeingDeleted(groupSnapshotContent *groupsnapshotv1.VolumeGroupSnapshotContent) (*groupsnapshotv1.VolumeGroupSnapshotContent, error) {
	if groupSnapshotContent == nil {
		return groupSnapshotContent, nil
	}
...
func (ctrl *csiSnapshotCommonController) removeGroupSnapshotFinalizer(groupSnapshot *groupsnapshotv1.VolumeGroupSnapshot, removeBoundFinalizer bool) error {
...
func (ctrl *csiSnapshotCommonController) getGroupSnapshotDriverName(vgs *groupsnapshotv1.VolumeGroupSnapshot) (string, error) {
